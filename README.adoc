...
--json [_FILE_PATH_]::
Save GitHub API issue payloads as JSON files instead of posting to GitHub. Automatically enables dry-run mode. If no path is specified, saves to timestamped file in `_payloads/` directory.
